// 发酵美食专栏封面批量下载 - 从 fermented-bv-details.json 读取封面 URL，存为 public/images/vlogs/<bvid>.jpg
...
const details = JSON.parse(
  fs.readFileSync(path.resolve('scripts/coldstart/out/fermented-bv-details.json'), 'utf-8')
)
