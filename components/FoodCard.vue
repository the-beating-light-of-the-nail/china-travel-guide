...
<template>
  ...
  <div class="card overflow-hidden card-hover cursor-pointer flex flex-col">
    ...
    <div class="h-[200px] overflow-hidden bg-slate-100">
      ...
      <div
        v-else
        class="w-full h-full flex items-center justify-center bg-gradient-to-br from-gold/15 via-gold/5 to-brand/10"
      >
    ...
    <div class="p-5 flex-1 flex flex-col">
      <!-- 标题 -->
      <h3 class="text-lg text-ink mb-2 font-semibold">{{ food.name[locale] }}</h3>

      <!-- 亮点 -->
      <div class="text-promo text-[13px] mb-2.5 font-medium">
