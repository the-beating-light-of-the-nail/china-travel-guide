...
const pack: LocalePack = {
  ...
  dumplingItems: [
    {
      name: 'Jiaozi (dumplings hervidos)',
      tagline: 'El dumpling original — la respuesta del norte de China a todo',
      description: 'El arquetipo del que deriva cada entrada de esta página: envoltura de trigo pellizcada en una gruesa media luna, hervida en agua a borbotones y servida seca con un cuenco de vinagre negro y ajo crudo. Rellenos: cerdo con col, cerdo con cebolleta o cordero con puerro en el noroeste. Comer jiaozi a medianoche en el Año Nuevo lunar es el ritual alimentario más fuerte del norte: la familia los pliega durante horas y se los come en minutos. Versiones vegetarianas (cebolleta y huevo, champiñones) hay en casi todas las cartas.',
      priceRef: 'Plato de ~15 unidades: ¥12–25',
      whereToEat: 'Casas de dumplings laozihao; tiendas de jiaozi en los hutongs de Pekín (mañana y noche)',
    },
    {
      name: 'Dumplings Zhong (钟水饺)',
      tagline: 'El icono de aceite de chili agridulce de Chengdu desde 1893',
      description: 'Dumplings de puro cerdo con piel fina y sedosa, bañados en una salsa brillante de aceite de chili agridulce, soja oscura, azúcar y un golpe generoso de ajo crudo — sin caldo, todo es cobertura. Fundado por Zhong Shaobai en 1893; el local original de la calle Tidu sigue acumulando colas, y las sucursales junto al monasterio Wenshu y el santuario Wuhou caen de camino. Los de Sichuan dirán que la salsa es el plato; tienen razón.',
      priceRef: '10 unidades: ¥10–15',
      whereToEat: 'Sucursales de Zhong Shuijiao — original en la calle Tidu, más las de Wenshu y Wuhou',
    },
    {
      name: 'Chao Shou (wontons en aceite rojo)',
      tagline: 'Wontons de «manos cruzadas» ahogados en aceite mala',
      description: 'El wonton de Sichuan: envoltura más fina y resbaladiza que el jiaozi, plegada para que las esquinas se crucen como manos entrelazadas — de ahí el nombre. La versión de aceite rojo llega en un baño escarlata de aceite de chili, pimienta de Sichuan, ajo y un chorrito de vinagre; pide «qing tang» (caldo claro) si quieres la gemela tranquila. Long Chaoshou, institución de Chengdu desde 1941, sirve ambos. Más pequeños que los wontons del norte: quince desaparecen sin darte cuenta.',
      priceRef: 'Bol de 10 unidades: ¥8–14',
      whereToEat: 'Long Chaoshou (龙抄手) en Chengdu; cualquier casa de fideos sichuanesa',
    },
    {
      name: 'Guo Tie (dumplings a la plancha)',
      tagline: 'Suelas doradas crujientes, relleno jugoso, listos en minutos',
      description: 'Dumplings largos y esbeltos fritos en una sartén con un fondo de agua y aceite para que la base se dore en encaje crujiente mientras la parte superior se cuece tierna. El contraste — crujido y luego jugo — es toda la gracia. Realeza del desayuno callejero: mira a los maestros verter agua, cerrar la tapa de un golpe y levantar veinte segundos después la sartén entera conectada. Se moja en vinagre con jengibre. La cadena Bafang Yunji es la opción fiable en todas partes.',
      priceRef: '8–10 unidades: ¥8–15',
      whereToEat: 'Puestos de desayuno callejero; locales de la cadena Bafang Yunji (八方云集)',
    },
    {
      name: 'Suan Tang Shui Jiao (dumplings en sopa agria)',
      tagline: 'El calentador de medianoche del barrio musulmán de Xi\'an',
      description: 'La respuesta de Xi\'an a la noche fría: dumplings de ternera o cordero (halal, potentes) flotando en un caldo afilado con vinagre negro, pimienta blanca, chili y una cucharada de aceite chisporroteante. La sopa es la mitad del pedido — primero ácida, luego picante, al final carnosa. Estándar en el barrio musulmán por Huajue y Beiyuanmen, donde los locales sirven hasta las 2 de la madrugada. Los de allí añaden vinagre y chili de los recipientes de la mesa; imítalos.',
      priceRef: '15 unidades con sopa: ¥13–18',
      whereToEat: 'Casas de dumplings del barrio musulmán (北院门/化觉巷), Xi\'an — abierto pasado medianoche',
    },
    {
      name: 'Sheng Jian Bao (bollitos a la plancha)',
      tagline: 'Bombas de caldo de base ambarina, al estilo Shanghái',
      description: 'Primas de piel gruesa de los xiaolongbao, fritas crudas («sheng») en una sartén ancha hasta que la base ampolla en ámbar, y luego cubiertas de sésamo y cebolleta. Dentro: un tapón de cerdo y un bolsillo de caldo hirviendo. El protocolo shanghainés: muerde un agujerito lateral, sorbe el caldo y después entra a por todo. Una ración son cuatro a seis — desayuno, no banquete — y los mejores locales se agotan a las 10 de la mañana. Hoy comunes en todas las calles gastronómicas.',
      priceRef: '4 unidades: ¥8–15',
      whereToEat: 'Casas de desayuno shanghainesas; calles gastronómicas de toda gran ciudad',
    },
    {
      name: 'Xiao Long Bao (dumplings de caldo)',
      tagline: 'El mago del aspic plumizo de Nanjing Road',
      description: 'El instrumento de precisión del mundo dumpling: envoltura fina como papel (idealmente ≥18 pliegues; Din Tai Fung exige exactamente 18) escondiendo una albóndiga de cerdo y un caldo que era aspic sólido al plegarlo. El vapor lo devuelve a caldo. Nació en Nanxiang, un pueblo a las afueras de Shanghái, y se perfeccionó en el delta del Yangtsé. Orden prescrito: a la cuchara, mordisquear la piel, beber el caldo, mojar el resto en vinagre de jengibre. Los de coral de cangrejo son el lujo de otoño.',
      priceRef: '6 unidades: ¥10–30; más caros en cadenas',
      whereToEat: 'Nanxiang Bun Shop (南翔馒头店) en el jardín Yu, Shanghái; casas de XLB de cada gran ciudad',
    },
    {
      name: 'Baozi (panecillos al vapor)',
      tagline: 'El reloj del desayuno chino: esponjoso, ¥2, en todas partes',
      description: 'El panecillo alto, esponjoso y totalmente cerrado — masa más gruesa que cualquier dumpling, como una nube de una fermentación larga. Se vende desde las 6 de la mañana en ventanas callejeras con vaporeras de bambú apiladas en torre, normalmente a ¥2–3 la pieza: cerdo asado al sur, cerdo con col o ternera con cebolla al norte — y siempre una opción vegetariana; el baozi de calabaza es un clásico discreto. En Pekín, la cadena Qingfeng es famosa por sí sola.',
      priceRef: 'Pieza ¥2–3; desayuno completo por menos de ¥10',
      whereToEat: 'Ventanas de vaporera callejeras; Qingfeng Baozipu (庆丰) en Pekín',
    },
    {
      name: 'Har Gow (dumplings de cristal de gambas)',
      tagline: 'El papel de tornasol del dim sum: translúcido, elástico, diez pliegues',
      description: 'El patrón de medida del yum cha cantonés: piel de almidón de trigo estirada hasta lo cristalino sobre una gamba picada entera que debe rebotar al morder. Los entendidos juzgan una casa de té únicamente por sus har gow — la piel debe ser translúcida sin romperse, los pliegues idealmente diez o más, y nada de fugas en la mesa. Llega en vaporera de bambú con una tetera de pu\'er o crisantemo al lado. El dim sum con carritos de fin de semana es uno de los grandes teatros gastronómicos de China.',
      priceRef: 'Vaporera de 4 unidades: ¥15–40',
      whereToEat: 'Casas de té y restaurantes de dim sum cantoneses en toda gran ciudad',
    },
    {
      name: 'Shu Mai (dumplings abiertos)',
      tagline: 'La copa plisada que nunca se cierra',
      description: 'El yin del yang del har gow en cada mesa de dim sum: envoltura amarilla fina recogida —sin sellar— en forma de tulipán abierto, con el relleno de cerdo y gamba asomando por arriba, a menudo con un punto naranja de hueva de cangrejo o zanahoria. Como nunca se cierra, el relleno queda suelto y jugoso mientras las paredes de la copa quedan sedosas. El norte tiene su versión de arroz glutinoso y cerdo en las ventanas del desayuno — más contundente e igual de barata.',
      priceRef: 'Vaporera de 4 unidades: ¥12–35',
      whereToEat: 'Restaurantes de dim sum; ventanas matinales del norte (versión de arroz glutinoso)',
    },
    {
      name: 'Fun Guo de Chaozhou (dumplings de cristal)',
      tagline: 'Piel translúcida, crujiente de cacahuete y cebolleta, a menudo vegetariano',
      description: 'La aportación teochew al canon del dim sum: una masa de trigo y almidón que al vapor alcanza una transparencia de vidrio de verdad, dejando ver el relleno — clásicamente cacahuetes, cebolleta, gambas secas y cerdo, una mezcla que cruje. Muchos locales hacen una versión totalmente vegetariana con cacahuete, cebolleta, champiñones y fideos de celofán, el as bajo la manga del vegetariano en el restaurante cantonés. Busca la forma ovalada regordeta con la costura superior trenzada.',
      priceRef: 'Vaporera de 3–4 unidades: ¥15–30',
      whereToEat: 'Restaurantes de dim sum teochew y cantoneses',
    },
    {
      name: 'Fideos con wontons (Yun Tun Mian)',
      tagline: 'Ingeniería cantonesa: wontons de gamba sobre un trampolín de fideos',
      description: 'Un clásico de Cantón y Hong Kong donde el dumpling es solo la mitad de la historia: wontons resbaladizos de gamba y cerdo (más pequeños y finos que sus primos del norte) aparcados sobre una balsa de fideos alcalinos de huevo que aguantan elásticos en un caldo claro con notas de pescado y dashi. Los tradicionalistas exigen fideos primero y wontons encima «para que la cama aguante». Un bol cuesta lo que un café y es comida completa a cualquier hora. El rebote de los fideos delata al buen local.',
      priceRef: 'Bol: ¥15–35',
      whereToEat: 'Cha chaan tengs hongkoneses y casas de fideos en todas las ciudades',
    },
    {
      name: 'Tangyuan (bolas dulces)',
      tagline: 'Lava de sésamo negro dentro de una bola de nieve',
      description: 'El final dulce de la familia dumpling: bolas de arroz glutinoso, blancas como nieve y masticables, rellenas de pasta de sésamo negro que se derrama como lava al primer mordisco (cacahuete y frijol rojo empatan en segundo lugar). Se sirven en su agua de cocción, o con arroz fermentado (jiuniang) en la versión adulta. Se comen en la Fiesta de los Faroles y el solsticio de invierno — la forma redonda significa reencuentro. Guizhou y Sichuan tienen también una tradición salada; para ir sobre seguro, pide «tian tangyuan» (dulce).',
      priceRef: 'Bol de 6–8 unidades: ¥6–15',
      whereToEat: 'Casas de postres, congelados del supermercado (marca Hayao), puestos festivos',
    },
    {
      name: 'Zongzi (paquetes de arroz glutinoso)',
      tagline: 'Paquetes de hoja de bambú, divisa del Festival del Barco Dragón',
      description: 'El «dumpling» más antiguo de China: arroz glutinoso envuelto en hojas de bambú o caña y hervido durante horas — comida portátil inventada hace milenios para el Festival del Barco Dragón, hoy vendida todo el año en carritos matinales. La gran fractura norte-sur: los zongzi del norte son dulces (dátiles rojos, pasta de frijol, mojados en azúcar); los del sur, salados (panceta, yema de huevo salada, champiñones — el zongzi de cerdo de Jiaxing es el estándar de oro). Desata el cordel, pela las hojas, y el arroz sale verde jade y perfumado a hoja.',
      priceRef: 'Pieza ¥3–8; las cajas de regalo, más caras',
      whereToEat: 'Carritos matinales, tiendas Wufangzhai (五芳斋), mercados del Festival del Barco Dragón',
    },
    {
      name: 'Tang Bao de Xi\'an (Jia San)',
      tagline: 'Panecillos de caldo de ternera y cordero del barrio musulmán',
      description: 'La lectura xi\'anesa del pan de caldo — más grande y audaz que la de Shanghái, relleno de ternera o cordero (cocina halal de la comunidad hui) y un vertido serio de caldo. Jia San, en la calle del Cordero Oeste (Xiyang Shi) del barrio musulmán, es el nombre que todos recomiendan: pieles de papel, una salsa de vinagre y chili que corta la grasa, y un comedor que gira como una fábrica de dumplings. Levántalo con palillos, apóyalo en la cuchara, ábrelo con cuidado — el más caldoso de la página.',
      priceRef: 'Vaporera de 8–10 unidades: ¥15–25',
      whereToEat: 'Jia San Guantangbao (贾三灌汤包子馆), calle Xiyang Shi, barrio musulmán de Xi\'an',
    },
  ],
}
