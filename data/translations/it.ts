...
const pack: LocalePack = {
  ...
  guides: {
    'china-dumpling-guide': {
      title: 'La guida ai ravioli di Cina: 15 varietà, cinque famiglie, un lungo pranzo',
      excerpt: 'Bolliti, al vapore, in padella, in brodo o dolci — come riconoscere ogni raviolo cinese, quanto pagare, come ordinare senza una parola di cinese e dove gustare ogni stile al meglio.',
      label: 'Guida gastronomica',
      readTime: 'Lettura 9 min',
    },
    'tiger-leaping-gorge-trek-guide': {
      title: 'Sentiero alto delle Gole del Salto della Tigre: guida completa in 2 giorni',
      excerpt: 'Il trek che ogni visitatore straniero dovrebbe fare nello Yunnan: trasporti da Lijiang o Shangri-La, scelta dei rifugi, i 28 tornanti e l\'arrivo alle rapide — senza permessi, tenda o guida.',
      label: 'Trek di 2 giorni',
      readTime: 'Lettura 9 min',
    },
    'china-trekking-permits-guide': {
      title: 'Permessi e regole del trekking in Cina: cosa possono (e non) fare gli stranieri',
      excerpt: 'Dove bastano le scarpe (quasi tutto Yunnan e Sichuan), dove serve un\'agenzia (tutto il Tibet) e cosa è vietato — più zone di confine, assicurazioni e soccorso.',
      label: 'Permessi e regole',
      readTime: 'Lettura 10 min',
    },
    'altitude-sickness-trekking-china': {
      title: 'Il mal di montagna sui trek cinesi: la guida in parole semplici',
      excerpt: 'Quali itinerari comportano rischio di AMS, le regole d\'oro dell\'acclimatazione, i sintomi che impongono la discesa immediata e come salire gradualmente invece di volare dritti a 4.400 m.',
      label: 'Guida all\'altitudine',
      readTime: 'Lettura 9 min',
    },
    ...
    "chengdu-airport-food-guide": {
      title: "Mangiare all'aeroporto Chengdu Tianfu (TFU): cosa mangiare, prezzi reali e soste notturne",
      excerpt:
        "Bloccato nel gigantesco nuovo aeroporto di Chengdu? Cosa c'è davvero a Tianfu (e Shuangliu) — ristoranti del terminal, il trucco da ¥10 al minimarket, dove mangiano gli equipaggi, prezzi delle capsule e quando conviene la metro linea 18.",
    ...
    "chengdu-vs-chongqing-food": {
      title: "Chengdu vs Chongqing: le differenze vere (brodo, piccante, scena e quale città scegliere)",
      excerpt:
        "Stessa famiglia culinaria, due città completamente diverse per chi mangia. Il duello sego di manzo contro olio chiaro, piatti jianghu contro stuzzichini da casa del tè, hot pot nel rifugio antiaereo contro bettole di vicolo — e la risposta onesta su quale città merita il tuo viaggio.",
      label: "Duello di città",
      readTime: "Lettura di 8 min",
    },
  ...
  hikingRoutes: [
    {
      name: 'Sentiero alto delle Gole del Salto della Tigre',
      region: 'Yunnan, vicino a Lijiang',
      tagline: 'Il trek cinese più famoso tra gli stranieri — rifugi, niente tenda',
      season: 'ott–apr (stagione secca)',
    },
    {
      name: 'Traversata dei pascoli del Wugongshan',
      region: 'Jiangxi, vicino a Pingxiang',
      tagline: 'Un mare d\'erba di 10.000 ettari sopra le nuvole',
      season: 'mag–ott; set. erba dorata',
    },
    {
      name: 'Ascensione notturna del Monte Hua',
      region: 'Shaanxi, vicino a Xi\'an',
      tagline: 'Scalinate di granito a 2.100 m — si sale di notte, alba sopra le nuvole',
      season: 'apr–ott',
    },
    {
      name: 'Sentieri di pietra di Zhagana',
      region: 'Gannan (Amdo tibetano), Gansu',
      tagline: 'Un villaggio tibetano di pietra sotto piramidi rocciose di 4.000 m',
      season: 'giu–ott',
    },
    {
      name: 'Yubeng e la kora del Meili',
      region: 'Deqin, Yunnan',
      tagline: 'Un villaggio senza strada nella valle sacra del Meili',
      season: 'apr–giu e set–nov',
    },
    {
      name: 'Laghi celesti di Daocheng Yading',
      region: 'Garzê (Kham, Sichuan)',
      tagline: 'Tre seimila sui laghi turchesi a 4.600 m',
      season: 'set–nov colori d\'autunno',
    },
    {
      name: 'Trek forestale Kanas–Hemu',
      region: 'Altay, Xinjiang',
      tagline: 'Foresta siberiana e steppa kazaka sotto le cime dell\'Altaj',
      season: 'giu–set; metà set. dorato',
    },
    {
      name: 'Traversata del Monte Siguniang (Changping→Bipeng)',
      region: 'Xiaojin, Sichuan',
      tagline: 'La parete di 6.250 m della «regina del Sichuan», da un capo all\'altro',
      season: 'mag–ott; fine set. larici dorati',
    },
    {
      name: 'Grande anello del Gongga (Minya Konka)',
      region: 'Kangding, Sichuan',
      tagline: 'Il giro del «re del Sichuan» da 7.556 m — ghiacciai, valichi e valli termali',
      season: 'mag–giu e set–ott',
    },
    {
      name: 'Linea dei pascoli del Genie',
      region: 'Litang, Sichuan',
      tagline: 'Un altopiano fiorito sotto un gigante inviolato di 6.204 m',
      season: 'giu–ott; lug. fioritura',
    },
    {
      name: 'Traversata del versante nord del Meili',
      region: 'Deqin, Yunnan',
      tagline: 'A faccia a faccia con i ghiacciai sospesi del lato nord',
      season: 'mag–ott',
    },
    {
      name: 'Attraversata dei laghi del deserto del Tengger',
      region: 'Alxa, Mongolia Interna',
      tagline: 'Tre giorni di dune, laghi salati e le stelle più assordanti della vita',
      season: 'apr–mag e set–ott',
    },
    {
      name: 'Kora del Monte Kailash',
      region: 'Ngari, Tibet',
      tagline: '52 km attorno alla montagna più sacra della Terra — quattro religioni',
      season: 'mag–ott; festa Saga Dawa (mag/giu)',
    },
    {
      name: 'Antico sentiero di Wusun',
      region: 'Ili–Aksu, Xinjiang',
      tagline: '2.000 anni di Via della Seta attraverso il Tianshan, fino al Lago del Cielo',
      season: 'solo giu–set',
    },
  ],
  dumplingItems: [
    {
      name: 'Jiaozi (ravioli bolliti)',
      tagline: 'Il raviolo per antonomasia — la risposta del Nord Cina a tutto',
      description: 'L\'archetipo da cui deriva ogni voce di questa pagina: involucro di grano pizzicato a mezzaluna pienotta, bollito in acqua a bollore e servito asciutto con una ciotolina di aceto nero e aglio crudo. Ripieni: maiale e cavolo, maiale e erba cipollina, o agnello e porro nel nord-ovest. Mangiare jiaozi a mezzanotte del Capodanno lunare è il rituale alimentare più sentito del Nord — la famiglia li piega per ore e li divora in minuti. Versioni vegetariane (erba cipollina e uovo, funghi) sono su quasi ogni menù.',
      priceRef: 'Piatto di ~15 pezzi: ¥12–25',
      whereToEat: 'Case di ravioli laozihao; botteghe di jiaozi negli hutong di Pechino (mattina e sera)',
    },
    {
      name: 'Ravioli Zhong (钟水饺)',
      tagline: 'L\'icona di olio di peperoncino agrodolce di Chengdu dal 1893',
      description: 'Ravioli di solo maiale dalla pelle sottile e setosa, bagnati in una salsa lucida di olio di peperoncino agrodolce, soia scura, zucchero e una dose pesante di aglio crudo — niente brodo, tutto nel condimento. Fondati da Zhong Shaobai nel 1893; la sede storica di via Tidu fa ancora fila, e le filiali vicino al monastero Wenshu e al santuario Wuhou cadono a fagiolo sul itinerario. I sichuanesi vi diranno che la salsa è il piatto: hanno ragione.',
      priceRef: '10 pezzi: ¥10–15',
      whereToEat: 'Filiali Zhong Shuijiao — storica in via Tidu, più quelle di Wenshu e Wuhou',
    },
    {
      name: 'Chao Shou (wonton all\'olio rosso)',
      tagline: 'Wonton dalle «mani incrociate» annegati nell\'olio mala',
      description: 'Il wonton del Sichuan: involucro più sottile e scivoloso del jiaozi, piegato così che gli angoli si incrocino come mani congiunte — da qui il nome. La versione all\'olio rosso arriva in un bagno scarlatto di olio di peperoncino, pepe del Sichuan, aglio e un goccio di aceto; per la gemella tranquilla chiedete «qing tang» (brodo chiaro). Long Chaoshou, istituzione di Chengdu dal 1941, serve entrambi. Più piccoli dei wonton del Nord — quindici spariscono senza accorgersene.',
      priceRef: 'Ciotola di 10 pezzi: ¥8–14',
      whereToEat: 'Long Chaoshou (龙抄手) a Chengdu; qualsiasi bottega di noodle sichuanese',
    },
    {
      name: 'Guo Tie (ravioli in padella)',
      tagline: 'Suole dorate croccanti, ripieno succoso, pronti in minuti',
      description: 'Ravioli lunghi e slanciati, fritti in padella con un fondo d\'acqua e olio finché il fondo indora a merletto croccante mentre il sopra cuoce al vapore tenero. Il contrasto — lo scrocchio, poi il succo — è tutto il senso. Regalità della colazione di strada: guardate i maestri versare l\'acqua, sbattere il coperchio e sollevare venti secondi dopo l\'intero foglio collegato. Si intinge in aceto con zenzero. La catena Bafang Yunji è l\'opzione affidabile ovunque.',
      priceRef: '8–10 pezzi: ¥8–15',
      whereToEat: 'Banchi di colazione stradali; punti catena Bafang Yunji (八方云集)',
    },
    {
      name: 'Suan Tang Shui Jiao (ravioli in brodo acido)',
      tagline: 'Lo scaldino di mezzanotte del quartiere musulmano di Xi\'an',
      description: 'La risposta di Xi\'an alle notti fredde: ravioli di manzo o agnello (halal, intensi) che galleggiano in un brodo affilato con aceto nero, pepe bianco, peperoncino e un cucchiaio d\'olio sfrigolante. Il brodo è metà dell\'ordine — prima acido, poi pepato, poi carnoso. Standard nel quartiere musulmano tra Huajue e Beiyuanmen, dove le botteghe servono fino alle 2 del mattino. I locali aggiungono aceto e peperoncino dai portatavola: fate come loro.',
      priceRef: '15 pezzi con brodo: ¥13–18',
      whereToEat: 'Botteghe di ravioli del quartiere musulmano (北院门/化觉巷), Xi\'an — aperto oltre mezzanotte',
    },
    {
      name: 'Sheng Jian Bao (panini in padella)',
      tagline: 'Bombe di brodo dalla base ambrata di Shanghai',
      description: 'Cugine dalla pelle spessa degli xiaolongbao, fritte crude («sheng») in una padella larga finché la base vescica in ambra, poi coperte di sesamo e cipollotto. Dentro: un tappo di maiale e una tasca di brodo bollente. Il protocollo di Shanghai: mordete un forellino laterale, succhiate il brodo, poi impegnatevi. Una porzione fa quattro-sei pezzi — una colazione, non un banchetto — e le botteghe migliori esauriscono entro le 10. Oggi comuni in ogni via dello street food.',
      priceRef: '4 pezzi: ¥8–15',
      whereToEat: 'Case di colazione shanghaiesi; vie gastronomiche di ogni grande città',
    },
    {
      name: 'Xiao Long Bao (ravioli al brodo)',
      tagline: 'Il mago dell\'aspic piumato di Nanjing Road',
      description: 'Lo strumento di precisione del mondo dei ravioli: involucro sottile come carta (idealmente ≥18 pieghe; Din Tai Fung ne esige esattamente 18) che nasconde una polpetta di maiale e un brodo che al momento della piegatura era aspic solido. Il vapore lo rifonde in brodo. Nato a Nanxiang, borgo alle porte di Shanghai, perfezionato nel delta dello Yangtze. Ordine prescritto: sul cucchiaio, rosicchiare la pelle, bere il brodo, intingere il resto nell\'aceto allo zenzero. Le versione al corallo di granchio sono il lusso d\'autunno.',
      priceRef: '6 pezzi: ¥10–30; di più nelle catene',
      whereToEat: 'Nanxiang Bun Shop (南翔馒头店) al giardino Yu, Shanghai; botteghe XLB di ogni grande città',
    },
    {
      name: 'Baozi (panini al vapore)',
      tagline: 'L\'orologio della colazione cinese: soffice, ¥2, ovunque',
      description: 'Il panino alto, soffice e completamente chiuso — impasto più spesso di qualsiasi raviolo, nuvoloso per la lunga lievitazione. In vendita dalle 6 alle finestre di strada in bamboo a vapore impilati a torre, di solito ¥2–3 al pezzo: char siu al sud, maiale e cavolo o manzo e cipolla al nord — e sempre un\'opzione vegetariana; il baozi alla zucca è un classico discreto. A Pechino la catena Qingfeng è famosa da sola come attrazione.',
      priceRef: 'Pezzo ¥2–3; colazione completa sotto ¥10',
      whereToEat: 'Finestre a vapore stradali ovunque; Qingfeng Baozipu (庆丰) a Pechino',
    },
    {
      name: 'Har Gow (ravioli di cristallo di gamberi)',
      tagline: 'Il tornasole del dim sum: traslucido, elastico, dieci pieghe',
      description: 'Il parametro dello yum cha cantonese: pelle di amido di grano stirata sottile come vetro su un gambero intero tritato che deve rimbalzare al morso. Gli intenditori giudicano una casa da tè solo dai suoi har gow — pelle traslucida senza strappi, pieghe idealmente dieci o più, nessuna perdita sul tavolo. Arriva nel bamboo con accanto una teiera di pu\'er o crisantemo. Il dim sum coi carrelli del weekend è uno dei grandi teatri gastronomici della Cina.',
      priceRef: 'Bamboo di 4 pezzi: ¥15–40',
      whereToEat: 'Case da tè e ristoranti di dim sum cantonesi in ogni grande città',
    },
    {
      name: 'Shu Mai (ravioli aperti)',
      tagline: 'La coppa plissettata che non si chiude mai',
      description: 'Lo yang dello yin dell\'har gow su ogni tavolo di dim sum: involucro giallo sottile raccolto — non sigillato — a tulipano aperto, con il ripieno di maiale e gambero che corona la sommità, spesso punteggiato da un corallo di granchio arancione o una monetina di carota. Non chiudendosi mai, il ripieno resta sciolto e succoso mentre le pareti della coppa diventano setose. Il Nord ha la sua versione di maiale e riso glutinoso alle finestre del mattino — più sostanziosa e ugualmente a ¥2.',
      priceRef: 'Bamboo di 4 pezzi: ¥12–35',
      whereToEat: 'Ristoranti di dim sum; finestre mattutine del Nord (versione riso glutinoso)',
    },
    {
      name: 'Fun Guo di Chaozhou (ravioli di cristallo)',
      tagline: 'Pelle traslucida, crocchiante di arachidi e erba cipollina, spesso vegetariano',
      description: 'Il contributo teochew di Chaozhou al canone del dim sum: un impasto di grano e amido che al vapore raggiunge una vera trasparenza da vetro, mostrando il ripieno — classicamente arachidi, erba cipollina, gamberi essiccati e maiale, un mix che crocchia. Molte botteghe fanno una versione completamente vegetariana con arachidi, erba cipollina, funghi e vermicelli di amido — l\'asso nella manica del vegetariano al ristorante cantonese. Cercate la forma ovale paffuta con la cucitura superiore intrecciata.',
      priceRef: 'Bamboo di 3–4 pezzi: ¥15–30',
      whereToEat: 'Ristoranti di dim sum teochew e cantonesi',
    },
    {
      name: 'Noodle ai wonton (Yun Tun Mian)',
      tagline: 'Ingegneria cantonese: wonton di gamberi su un tappeto elastico di noodle',
      description: 'Un classico di Canton e Hong Kong in cui il raviolo è solo metà della storia: wonton scivolosi di gamberi e maiale (più piccoli e fini dei cugini del Nord) parcheggiati su una zattera di noodle all\'uovo alcalini che restano elastici in un brodo chiaro dalle note di pesce e dashi. I puristi esigono prima i noodle e poi i wonton sopra «perché il letto resti sodo». Una ciotola costa come un caffè ed è un pasto completo a qualsiasi ora. Il rimbalzo dei noodle tradisce la bottega giusta.',
      priceRef: 'Ciotola: ¥15–35',
      whereToEat: 'Cha chaan teng hongkonghesi e botteghe di noodle in ogni città',
    },
    {
      name: 'Tangyuan (palline dolci)',
      tagline: 'Lava di sesamo nero dentro una palla di neve',
      description: 'Il capolinea dolce della famiglia: palline di riso glutinoso, bianche come neve e gommose, ripiene di pasta di sesamo nero che fuoriesce come lava al primo morso (arachide e fagiolo rosso a pari merito). Servite nella loro acqua di cottura, o con riso fermentato (jiuniang) nella versione adulta. Si mangiano alla Festa delle Lanterne e al solstizio d\'inverno — la forma tonda significa riunione. Guizhou e Sichuan hanno anche una tradizione salata; per sicurezza chiedete «tian tangyuan» (dolce).',
      priceRef: 'Ciotola di 6–8 pezzi: ¥6–15',
      whereToEat: 'Locali di dessert, banco surgelati dei supermercati (marca Hayao), banchi di festa',
    },
    {
      name: 'Zongzi (fagottini di riso glutinoso)',
      tagline: 'Involucri di foglie di bambù, valuta della Festa delle Barche Drago',
      description: 'Il «raviolo» più antico della Cina: riso glutinoso avvolto in foglie di bambù o canna e bollito per ore — cibo da viaggio inventato millenni fa per la Festa delle Barche Drago, oggi venduto tutto l\'anno nei carrelli del mattino. La grande frattura Nord-Sud: gli zongzi del Nord sono dolci (datteri rossi, pasta di fagiolo, intinti nello zucchero); quelli del Sud salati (pancetta, tuorlo salato, funghi — lo zongzi di maiale di Jiaxing è lo standard oro). Sciogliete lo spago, sbucciate le foglie, e il riso esce verde giada e profumato di foglia.',
      priceRef: 'Pezzo ¥3–8; i cofanetti costano di più',
      whereToEat: 'Carrelli del mattino, negozi Wufangzhai (五芳斋), mercati della Festa delle Barche Drago',
    },
    {
      name: 'Tang Bao di Xi\'an (Jia San)',
      tagline: 'Panini al brodo di manzo e agnello del quartiere musulmano',
      description: 'L\'interpretazione xi\'anese del panino al brodo — più grande e audace di quella di Shanghai, ripieno di manzo o agnello (cucina halal della comunità hui) e con una dotazione seria di brodo. Jia San, in via della Pecora Ovest (Xiyang Shi) nel quartiere musulmano, è il nome che tutti raccomandano: pelli di carta, una salsa aceto-peperoncino che taglia il grasso, e una sala che gira come una fabbrica di ravioli. Sollevatelo con le bacchette, appoggiatelo sul cucchiaio, aprite con cautela — il più brodoso della pagina.',
      priceRef: 'Bamboo di 8–10 pezzi: ¥15–25',
      whereToEat: 'Jia San Guantangbao (贾三灌汤包子馆), via Xiyang Shi, quartiere musulmano di Xi\'an',
    },
  ],
}
